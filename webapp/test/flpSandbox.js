		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "To Do List",
									"targetURL": "#insijastodolist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"insijastodolist-display": {
								"semanticObject": "insijastodolist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.sijas.todolist",
									"url": sap.ui.require.toUrl("in/sijas/todolist")
								}
							}
						}
					}
